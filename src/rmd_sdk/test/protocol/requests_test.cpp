...
#include "rmd_sdk/protocol/requests.hpp"
...
namespace rmd_sdk {
  namespace test {
    ...
    TEST(GetCanIdRequestTest, parsing) {
      rmd_sdk::GetCanIdRequest const request {{0x79, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00}};
      bool const is_write {request.isWrite()};
      EXPECT_EQ(is_write, false);
    }

    TEST(SetCanBaudRate0RequestTest, parsing) {
      rmd_sdk::SetCanBaudRateRequest const request {{0xB4, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00}};
    ...
    TEST(SetCanBaudRate1RequestTest, parsing) {
      rmd_sdk::SetCanBaudRateRequest const request {{0xB4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01}};
      CanBaudRate const baud_rate {request.getBaudRate()};
      EXPECT_EQ(baud_rate, CanBaudRate::MBPS1);
    }

    TEST(SetEncoderZeroRequestTest, parsing) {
      rmd_sdk::SetEncoderZeroRequest const response {{0x63, 0x00, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00}};
    ...
    TEST(SetPositionPlanningAccelerationRequestTest, parsing) {
      rmd_sdk::SetAccelerationRequest const request {{0x43, 0x00, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00}};
    ...
    TEST(SetPositionPlanningDecelerationRequestTest, parsing) {
      rmd_sdk::SetAccelerationRequest const request {{0x43, 0x01, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00}};
      std::uint32_t const acceleration {request.getAcceleration()};
      AccelerationType const mode {request.getMode()};
      EXPECT_EQ(acceleration, 10000);
    ...
    TEST(SetVelocityPlanningAccelerationRequestTest, parsing) {
      rmd_sdk::SetAccelerationRequest const request {{0x43, 0x02, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00}};
      std::uint32_t const acceleration {request.getAcceleration()};
      AccelerationType const mode {request.getMode()};
      EXPECT_EQ(acceleration, 10000);
    ...
    TEST(SetVelocityPlanningDecelerationRequestTest, parsing) {
      rmd_sdk::SetAccelerationRequest const request {{0x43, 0x03, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00}};
      std::uint32_t const acceleration {request.getAcceleration()};
      AccelerationType const mode {request.getMode()};
      EXPECT_EQ(acceleration, 10000);
    ...
    TEST(SetControllerGainsPersistentlyRequestTest, parsing) {
      rmd_sdk::SetControllerGainsPersistentlyRequest const request {{0x32, 0x00, 0x55, 0x19, 0x55, 0x19, 0x55, 0x19}};
      rmd_sdk::Gains const gains {request.getGains()};
    ...
    TEST(SetControllerGainsRequestTest, parsing) {
      rmd_sdk::SetControllerGainsRequest const request {{0x31, 0x00, 0x55, 0x19, 0x55, 0x19, 0x55, 0x19}};
      rmd_sdk::Gains const gains {request.getGains()};
      EXPECT_EQ(gains.current.kp, 85);
      EXPECT_EQ(gains.current.ki, 25);
      EXPECT_EQ(gains.speed.kp, 85);
    ...
    TEST(SetPositionAbsoluteRequestTest, parsingPositivePosition) {
      rmd_sdk::SetPositionAbsoluteRequest const request ({0xA4, 0x00, 0xF4, 0x01, 0xA0, 0x8C, 0x00, 0x00});
    ...
    TEST(SetPositionAbsoluteRequestTest, parsingNegativePosition) {
      rmd_sdk::SetPositionAbsoluteRequest const request ({0xA4, 0x00, 0xF4, 0x01, 0x60, 0x73, 0xFF, 0xFF});
      auto const position {request.getPosition()};
      EXPECT_NEAR(position, -360.0f, 0.1f);
      auto const max_speed {request.getMaxSpeed()};
      EXPECT_NEAR(max_speed, 500.0f, 0.1f);

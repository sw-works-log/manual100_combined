...
#ifndef RMD_SDK__TEST__ACTUATOR_ACTUATOR_MOCK_TEST
#define RMD_SDK__TEST__ACTUATOR_ACTUATOR_MOCK_TEST
#pragma once
  ...
  namespace test {
    ...
    */
    class ActuatorActuatorMockTest: public ::testing::Test {
      ...
      protected:
        rmd_sdk::CanDriver driver_;
        rmd_sdk::ActuatorInterface actuator_;
...
#endif // RMD_SDK__TEST__ACTUATOR_ACTUATOR_MOCK_TEST
